...
PLUGINLIB_EXPORT_CLASS(filters::SurfaceNormalsFilter<grid_map::GridMap>, filters::FilterBase<grid_map::GridMap>)
// PLUGINLIB_REGISTER_CLASS(SurfaceNormalsFilter, filters::SurfaceNormalsFilter<grid_map::GridMap>,filters::FilterBase<grid_map::GridMap>);
